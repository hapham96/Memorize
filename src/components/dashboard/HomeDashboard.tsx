  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-4 md:px-8 py-5 space-y-6 pb-28 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 bg-blue-600 border-clay border-blue-400 text-white rounded-[28px] p-6 shadow-clay-lg relative overflow-hidden flex items-center justify-between group hover:shadow-clay-xl transition-all duration-300">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-[28px] p-5 border-clay border-blue-200 dark:border-slate-700 shadow-clay-sm flex flex-col justify-between hover:border-indigo-400 transition-all">
            ...
            {focusCategories.length > 0 ? (
              <div className="flex flex-wrap gap-1.5">
                {focusCategories.map((c) => (
                  <span
                    key={c}
                    className="text-xs font-bold px-2.5 py-1 rounded-xl bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border-clay border-indigo-300 dark:border-indigo-800"
                  >
                    {c}
                  </span>
                ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div
          ...
          className="bg-blue-50 dark:bg-slate-800 rounded-[24px] p-5 border-clay border-blue-300 dark:border-slate-700 shadow-clay-sm hover:shadow-clay-lg hover:border-blue-500/50 cursor-pointer transition-all duration-300 group flex flex-col justify-between"
        >
          <div className="flex items-start justify-between">
            <div className="w-12 h-12 rounded-2xl bg-blue-600 border-clay border-blue-400 text-white flex items-center justify-center shadow-clay group-hover:scale-110 transition-transform">
        ...
        <div
          ...
          className="bg-white dark:bg-slate-800 rounded-[24px] p-5 border-clay border-blue-200 dark:border-slate-700 shadow-clay-sm hover:shadow-clay-lg hover:border-blue-500/50 cursor-pointer transition-all duration-300 group flex flex-col justify-between"
        >
          <div className="flex items-start justify-between">
        ...
        <div
          ...
          className="bg-white dark:bg-slate-800 rounded-[24px] p-5 border border-emerald-500/30 dark:border-emerald-500/20 shadow-clay-sm hover:shadow-clay-lg hover:border-emerald-500 cursor-pointer transition-all duration-300 group flex flex-col justify-between"
        >
          <div className="flex items-start justify-between">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-slate-800 p-5 rounded-[24px] border-clay border-blue-200 dark:border-slate-700 shadow-clay-sm flex flex-col justify-between">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-[24px] p-5 border-clay border-blue-200 dark:border-slate-700 shadow-clay-sm">
                  ...
                  <div className="w-full bg-slate-100 dark:bg-slate-700/50 rounded-lg h-full flex items-end overflow-hidden">
                    <div
                      ...
                      className={`w-full rounded-lg transition-all duration-500 ${
                        isToday ? 'bg-blue-600' : 'bg-blue-400/40 dark:bg-blue-400/25'
                      }`}
                    />
                  </div>
                  <span
