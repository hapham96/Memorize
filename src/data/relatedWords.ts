...
export const SMART_WORDS_DATABASE: Record<string, SuggestedWordDetails> = {
  ...
  tailor: {
    ...
    ipa: '/ˈteɪ.lər/',
    pos: 'n.',
    definition: 'A person whose occupation is making fitted clothes for individual customers.',
    vietnamese: 'thợ may',
  ...
  invoice: {
    ...
    ipa: '/ˈɪn.vɔɪs/',
    pos: 'n.',
    definition: 'A commercial document that itemizes and records a transaction between a buyer and seller.',
  ...
  passport: {
    ...
    ipa: '/ˈpɑːs.pɔːt/',
    pos: 'n.',
    definition: 'An official government document certifying identity and citizenship for international travel.',
    vietnamese: 'hộ chiếu',
